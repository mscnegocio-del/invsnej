  ...
  'relative w-full rounded-xl border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground',
  {
    variants: {
      variant: {
        ...
        warning:
          'border-amber-400/50 text-amber-800 dark:text-amber-400 [&>svg]:text-amber-600 bg-amber-50 dark:bg-amber-900/20',
        success:
          'border-emerald-400/50 text-emerald-800 dark:text-emerald-400 [&>svg]:text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20',
      },
    },
    defaultVariants: {
      variant: 'default',
